...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "lubbo"
  # s.authors            = { "lubbo" => "davide.ramo.ve@gmail.com" }
  # s.social_media_url   = "http://twitter.com/lubbo"
  ...
  s.subspec 'SimpleApp' do |ss|
    ss.dependency 'FastPdfKit/Core'
    ss.source_files = 'Classes/SimpleApp/Controllers'
    ss.resources = 'Classes/SimpleApp/Controllers/*.xib'
  end

  s.subspec 'Reader' do |ss|
    ss.dependency 'FastPdfKit/Core'
    ss.source_files = 'Classes/Reader', 'Classes/Reader/Multimedia' , 'Classes/Reader/Bookmarks', 'Classes/Reader/Outline', 'Classes/Reader/TextSearch'
    ss.resources = 'Classes/Reader/Multimedia/*.{xib}' , 'Classes/Reader/Bookmarks/*.{xib}', 'Classes/Reader/Outline/*.{xib}', 'Classes/Reader/TextSearch/*.{xib}'
  end
