...
EOS
  ...
  s.subspec 'Sync' do |sy|
    ...
    sy.subspec 'MQTTMosquitto' do |symqttmos|
      symqttmos.source_files   = 'Code/SDSyncMQTTMosquitto.h', 'Code/Sync/MQTTMosquitto'

      symqttmos.dependency 'MQTTKit', '0.1.0-sysdata6'

      symqttmos.dependency 'SysdataCore/Sync/Core'

      symqttmos.prefix_header_contents = <<-EOS
      #import <SDSyncMQTTMosquitto.h>
      EOS
    end
    ...
    sy.subspec 'MQTTClient' do |symqttclient|
      ...
      symqttclient.prefix_header_contents = <<-EOS
      #import <SDSyncMQTTClient.h>
      EOS
    end
