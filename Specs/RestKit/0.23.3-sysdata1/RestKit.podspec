Pod::Spec.new do |s|
  s.name             =  'RestKit'
  s.version          =  '0.23.3-sysdata1'
  s.summary          =  'RestKit is a framework for consuming and modeling RESTful web resources on iOS and OS X.'
  s.homepage         =  'http://www.restkit.org'
  s.social_media_url =  'https://twitter.com/RestKit'
  s.author           =  { 'Blake Watters' => 'blakewatters@gmail.com' }
  s.source           =  { :git => 'https://github.com/SysdataItaliaSpA/RestKit.git', :tag => "v#{s.version}" }
...
EOS
  ...
  s.subspec 'CoreData' do |cdos|
    cdos.source_files = 'Code/CoreData.h', 'Code/CoreData', 'Code/CoreData/Sysdata'
